...
const Testimonials = () => {
  ...
  <section className={classes.section_testimonials} id="testimonials">
            ...
            <div className={classes.testimonials_container}>
                ...
                <h2 className="heading-secondary">Once you try it, you can't go back
                </h2>
                ...
                <div className={classes.testimonials}>
                    ...
                    <figure className="testimonial">
                        <img src={hannah} className="" alt="Photo of Customer Dave Bryson" />
                        <blockquote className={classes.testimonial_text}>
            ...
            <div className={classes.gallery}>
                ...
                <figure className={classes.gallery_item}>
                    <img src={gallery_2} alt="Photo of beautifully arranged food" />
                </figure>
                <figure className={classes.gallery_item}>
                ...
                <figure className={classes.gallery_item}>
                    <img src={gallery_9} alt="Photo of beautifully arranged food" />
                </figure>
                <figure className={classes.gallery_item}>
                    <img src={gallery_10} alt="Photo of beautifully arranged food" />
                </figure>
                <figure className={classes.gallery_item}>
